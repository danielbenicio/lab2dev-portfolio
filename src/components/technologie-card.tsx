...
export const TechnologieCard: React.FC<TechnologieCardProps> = ({
  ...
  return (
    <div className="shadow-card pt-4 pb-6 px-5 rounded max-h-80 max-w-xs">
      <div className="w-16 h-16 border flex items-center justify-center rounded mb-6">
        <Image
      ...
      <span className="font-semibold opacity-50 text-sm">{description}</span>
    </div>
  )
}
